...
const kuaData = {
    1: {
        ...
        directionEffects: {
            "דרום מזרח": "זוגיות והצלחה - מחזק קשרים רומנטיים ומשפר יחסים חברתיים",
            "מזרח": "בריאות ומשפחה - תומך בבריאות כללית ומחזק קשרי משפחה",
            "דרום": "הצלחה והכרה - מביא הצלחה בקריירה ותהילה",
            "צפון": "קריירה וחוכמה - תומך בהתפתחות מקצועית ורכישת ידע"
        }
    },
    2: {
        ...
        directionEffects: {
            "צפון מזרח": "ידע והשכלה - תומך בלמידה ורכישת ידע חדש",
            "מערב": "ילדים ויצירתיות - מחזק קשרים עם ילדים ומעודד יצירתיות",
            "צפון מערב": "נסיעות ותמיכה - מביא הזדמנויות לנסיעות ומחזק קשרים עם אנשים מבוגרים",
            "דרום מערב": "אהבה וזוגיות - מחזק קשרים רומנטיים ויציבות רגשית"
        }
    },
    3: {
